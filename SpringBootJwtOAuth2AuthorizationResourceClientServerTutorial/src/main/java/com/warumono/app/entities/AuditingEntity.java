...
//	@JsonProperty(access = Access.WRITE_ONLY)
	...
	@LastModifiedBy
	@Column(updatable = true, nullable = true, columnDefinition = "VARCHAR(50) COMMENT '수정자 identity'")
	...
	@CreatedBy
	@Column(updatable = false, nullable = true, columnDefinition = "VARCHAR(50) COMMENT '생성자 identity'")
